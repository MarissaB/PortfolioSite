<%@ Page Title="M Berresford - Project Porfolio" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="portfolio.aspx.cs" Inherits="Default3" %>


<asp:Content ID="Content2" ContentPlaceHolderID="bodypage" Runat="Server">
    <p class="title2">What I've Done</p>
    ...
    <hr />
    <p class="title2">Game Inventory</p>
    <ul class="nobullet">
        <li class="info">A basic inventory program for tracking purchased video games as a collector.</li>
        <li class="folder">C#, Entity Framework, SQL/LINQ</li>
        <li class="git"><a class="github" href="https://github.com/MarissaB/GameInventory">Check it out on GitHub!</a></li>
    </ul>
    <p>I made this to better organize my collection of console and handheld video games. I'd worked with inventory systems when offloading trucks in retail, so I figured why not create a similar version to help my purchasing prowess.</p>
    <hr />
    <p class="title2">Google Script Tools</p>
    <ul class="nobullet">
        <li class="info">A small collection of useful tools I've put together in Google Scripts</li>
        <li class="folder">Google Apps Script (aka Javascript)</li>
